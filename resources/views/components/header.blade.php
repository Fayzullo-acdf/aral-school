@props(['menus', 'site_translations'])

<section id="navbar">
    <div class="container">
        <div class="banner">
            <div class="banner-textbox">
                {!! $site_translations->banner_text ?? null !!}
            </div>
        ...
        <div class="navigation">
            <div class="navigation_bottom">
                ...
                <div class="hamburger_button" id="hamburger" role="button" tabindex="0" aria-controls="mobile-menu"
                    aria-expanded="false">
